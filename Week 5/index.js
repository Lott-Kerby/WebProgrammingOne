...
document.addEventListener('DOMContentLoaded', function()
{
    ...
    document.getElementById("ABT_Button").addEventListener('click', function ()
    {
        ...
        document.getElementById("WL_view").style.display = "none";
    });
    ...
    /*School Waitlist button handler */
    document.getElementById("WL_Button").addEventListener('click', function ()
    {
        document.getElementById("About_me_view").style.display = "none";
        document.getElementById("Travel_list_view").style.display = "none";
        document.getElementById("RPS_view").style.display = "none";
        document.getElementById("WL_view").style.display = "block";
    });
...
/*button handlers for school dropdown menu */
function onClick_lincoln()
{
    document.getElementById("School_info").innerHTML = "School Info: Average gpa of admitted students is 3.00, Tech magnet program";
}

function onClick_xavier()
{
    document.getElementById("School_info").innerHTML = "School Info: Average gpa of admitted students is 3.3, Nationally ranked tennis program";
}

function onClick_hogwarts()
{
    document.getElementById("School_info").innerHTML = "School Info: Students generally perform wizardry";
}

/*This function will execute when the submit button is clicked */
function formSubmit(theForm)
{
    document.getElementById("Submit_confirm").innerHTML = "Form submitted!";
